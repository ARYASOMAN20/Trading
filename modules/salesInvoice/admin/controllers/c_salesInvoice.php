...
//}	
	...
	//{ 
		$tbody.='<tr>
				<td colspan="8" align="right">Damage Goods Amount :</td>
...
/// New Design  - NarayananG 02-08-2024
function getInvoiceDetailsNewDesign($invoiceId)
	{
...
if($invoiceRefId==''){
	...
	<table width="100%" border="0"  style="font-size: 12px !important;border-collapse:collapse;">
				<thead>
			<tr>
				<td align="center" width="4%" colspan="8">&nbsp;</td>
				<!--<td width="12%">Barcode/Item(الاسم الصنف)</td>
				<td align="center" width="5%">Qty<br/>الكمية </td>
				<td align="center" width="5%">Unit<br/>وحدة</td>
				<td align="center" width="5%">Weight<br/>الوزن </td>
	...
	<tbody>';
    	...
    	$tbody .='<br><div style="margin-left: 5%;">
	<table width="100%" border="0"  style="font-size: 12px !important;border-collapse:collapse">
				<thead>
			<tr>
...
//}	
	...
	while($invoiceDetailsRow	=	mysqli_fetch_array($invoiceDetails))
		{
			...
			if($invoiceRefId==''){
					$tbody.='<tr>
			<td align="left" width="6%">'.$i.'</td>
			<td width="29%" align="left">'.$invoiceDetailsRow['itemCode'].'/'.$invoiceDetailsRow['itemName'].'<br>('.$invoiceDetailsRow['itemNameArabic'].')</td>
			
			<td align="center" width="10%" style="text-align:center">'.$invoiceDetailsRow['quantity'].'</td>
			<td align="left" width="7%">'.$invoiceDetailsRow['unitName'].'</td>
			<!-- <td align="right" width="5%">'.number_format($invoiceDetailsRow['netWeight'],2).'</td> -->
			<td align="left" width="7%">'.number_format($invoiceDetailsRow['unitPrice'],2).'</td>
			<td align="left" width="9%">'.number_format($invoiceDetailsRow['amount'],2).'</td>
			<td align="center" width="10%">'.number_format($invoiceDetailsRow['vatAmount'],2).'</td>
			<td align="center" width="7%">'.number_format($invoiceDetailsRow['amountWithVat'],2).'</td>
			...
			<td width="6%">'.$invoiceDetailsRow['itemCode'].'/'.$invoiceDetailsRow['itemName'].'('.$invoiceDetailsRow['itemNameArabic'].')</td>
			
			<td align="right" width="9%">'.$invoiceDetailsRow['quantity'].'</td>
			<td align="center" width="2%">'.$invoiceDetailsRow['unitName'].'</td>
			<td align="right" width="5%">'.number_format($invoiceDetailsRow['unitPrice'],2).'</td>
			<td align="right" width="3%">'.number_format($invoiceDetailsRow['amount'],2).'</td>
			<!--<td align="center" width="3%">'.number_format($invoiceDetailsRow['discountPercent'],2).'</td>
			<td align="center" width="3%">'.$invoiceDetailsRow['vatPercent'].'</td>
			<td align="center" width="3%">'.number_format($invoiceDetailsRow['vatAmount'],2).'</td>
			<td align="center" width="3%">'.number_format($invoiceDetailsRow['amountWithVat'],2).'</td>-->
		</tr>';
			//}
				$i++;
				$qtyTotal         			=	$qtyTotal +$invoiceDetailsRow['quantity'];
	...
	<tr>
		...
		<td rowspan="4" align="center" width="20%"> <img src="'.$base64.'" height="90px" width="90px" > </td>
		<td   align="right" >'.number_format($totalAmount,2).'</td>
	</tr>
	<tr>
		<td align="right"> &nbsp; </td>
...
$tbody.='<tr>
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
			<table width="100%" border="0"  style="font-size: 12px !important;border-collapse:collapse;border-spacing: 0 20px;">
			<tr>
				<td align="right" width="52%">  &nbsp; </td>
				<td rowspan="5" align="center" width="20%"> <img src="'.$base64.'" height="100px" width="100px" > </td>
				<td   align="right" >'.number_format($totalAmount,2).'</td>
			</tr>
			<tr>
				<td align="right"> &nbsp; </td>
		...
		$tbody.='<tr style="height: 20px !important;">
				<td align="right"> &nbsp; </td>
				<td  align="right" >'.number_format($vatAmount,2).'</td>
			</tr> 
...
if($privilageId==2 || $privilageId==6)
{
	...
	if($privilageId==2&&$mainBranch=='M')
		{
			$thead	.='	<tr>
					...
					<!--<th></th>-->
					<th style="text-align: right;"><span> <b>الرقم سجل تجاري</span><span></b></span> </th>
				</tr>
				<tr>
					<th align="left">VAT NO: </th>
					<!--<th width="35%"></th>-->
	...
	<thead>
		...
		<tr>
			<td  width="48%">TO: '.$customerName.'<br/>'.$address .'</td>
			<td class="tdd" ></td>
			<td class="tdd" width="51%">INVOICE NO: '.$invoiceNo.'</td>
		</tr>
		<tr>
			<td class="tdd">VAT NO: '.$vatNumber.'</td>
			<td class="tdd"></td>
			<td width="49%">INVOICE DATE: '.date_format(date_create($invoiceDate),"d-m-Y").'</td>
		</tr>
		<!--<tr>
			<td>PO No:'.$poNo.'</td>
			<td>DUE DATE</td>
...
/*if($checkDiscount==0)
{
	...
	$tbody .='<table width="100%" border="1"  style="font-size: 12px !important;" class="divFullWidth">
				<thead>
			<tr>
				<td align="center" width="3%">#</td>
				<td width="12%">Barcode/Item(الاسم الصنف)</td>
...
//}	
	...
	if($privilageId==2&&$mainBranch=='M')
		{
			$tbody.='<tr>
				<td colspan="6" align="right">Cutting Charge :</td>
...
$tbody.='<tr>
	...
	<table width="100%" style="font-size: 13px;" border="0">
					...
					{		
				$tbody.='	<tr>
								<th colspan="6" style="text-align:left">USER: '.$userName.'</th>
							</tr>';
					}
