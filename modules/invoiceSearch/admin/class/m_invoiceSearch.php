...
class M_InvoiceSearch {
	...
	function otherChargesDetails($invoiceId)
	{
			global $con;
				 ...
				 $query = " SELECT Q.labourCharges ,Q.otherCharges ,
	...
	global $con;
	 $query = "SELECT Q.quotationNo,QI.quotationInvoiceNo,Q.otherCharges,Q.labourCharges,Q.quotationTotalAmount,
					...
					Q.quotationId,R.customerNo,Q.quotationDate,Q.labourCharges,Q.otherCharges,vatInPercentage,vatInAmount,billTotalWithVat,
					billTotal
			  FROM quotation Q
