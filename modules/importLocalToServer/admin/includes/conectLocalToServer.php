...
if(isset($_GET['selectedInvoiceIds']))
{
    ...
    if(count($arayexplode)>0)
    {
        ...
        for($j=0;$j<count($arayexplode);$j++)
        {
            ...
            $query6 = "SELECT * FROM invoice WHERE invoiceId='".$invoiceId."' AND connectedStatus=0";
            ...
            if($numRows==1)
            {
                ...
                */
                ...
                // header("welcome.php?page=salesInvoiceConnect");
                // echo 'test';
                header("location:http://".$_SERVER['HTTP_HOST']."/naf/assets/system/php/dashboard/welcome.php?page=salesInvoiceConnect");
            }
