...
if(isset($_POST['details'])){
 ...
 if($resInvoiceDetailsView!=1)
 {
$customerName          = $resInvoiceDetailsView['customerName'];
$invoiceDate		   = $resInvoiceDetailsView['invoiceDate'];
$invoiceNo             = $resInvoiceDetailsView['invoiceNo'];
$transactionType       =$resInvoiceDetailsView['transactionType'];
...
$invoiceDetailsTables  = $resInvoiceDetailsView['invoiceDetailsTables'];

}
else
{
header("location:welcome.php?page=invoiceSearchByDate");	
}
}
?>
...
table tr.listItemTr td strong{font-size: 10px !important;}
     ...
     <div class="panel-heading"><h3 class="panel-title"><strong style="font-size: 18px;">INVOICE DETAILS</strong></br></br> Invoice No :<?php echo $invoiceNo; ?> &nbsp;&nbsp;&nbsp; Invoice Date : <?php echo $invoiceDate;?> &nbsp;&nbsp;&nbsp;<?php echo $invoiceType.'Invoice'; ?>&nbsp;<br /><br /> Customer Name :<?php echo $customerName; ?>&nbsp;&nbsp;&nbsp;&nbsp; </h3>
		                         </div>
	 <div class="box-body">
	<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table table-responsive table-bordered table-condensed">                                                                                                                                                                                                               
               			<thead>
                            <tr>
                                <th style="text-align: left">SI.N0</th>
    ...
    <center>
         ...
         <a href="welcome.php?page=invoicePrintByInvoiceNo&invoiceId=<?php echo $invoiceId?>">
            <button type="button" id="" name="printPageButton" onClick="printPage('block1');"
