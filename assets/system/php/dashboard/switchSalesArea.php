...
switch($choice) {
    ...
    case 'jvPrint'  :  
		  ...
		  break;
    case 'cashReceiptSalesareaPrint'  :  
		  include("../../../../modules/cashReceipt/admin/includes/cashReceiptPrint.php" );
		  break;
    case 'cashPayment'  :  
    ...
    case 'salesReturnsearch'  :  
		  ...
		  break;
    case 'monthlySalesAndCashReport'  :  
		  include("../../../../modules/monthlySalesAndCashReport/admin/includes/monthlySalesAndCashReport.php" );
		  break;
    case 'damageGoodReturnReport'  :  
		  include("../../../../modules/damageGoodReturnReport/admin/includes/damageGoodReturnReport.php" );
		  break;
