              	...
              	<ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                      	...
                      	<ul class="treeview-menu">
                            ...
                            <li>
                            	<a href="welcome.php?page=addSalesman">
                                	<i class="fa fa-circle-o"></i> Salesman
                                </a>
                            </li>
                            <li>
                	...
                	<!--<li class="treeview">
                  		...
                  		<ul class="treeview-menu">
                            ...
                            <li>
                            	<a href="welcome.php?page=salesReturnView">
    ...
    <li class="treeview">
                  		...
                  		<ul class="treeview-menu">
                            ...
                            <li>
                                ...
                                <i class="fa fa-clipboard"></i> <span>Purchase</span>
                                    ...
                                    <li>
                                	<a href="welcome.php?page=stockTransitReport">
                        ...
                        <li class="treeview">
                      	...
                      	<ul class="treeview-menu">
                            ...
                            <li>
                            	<a href="welcome.php?page=storeImportPurchasePrint">
                                	<i class="fa fa-circle-o"></i> Store Import Purchase
                                </a>
                            </li>
                            <li>
