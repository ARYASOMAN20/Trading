            ...
            <section class="sidebar">
                ...
                <!-- search form -->
              	...
              	<ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                      	<a href="welcome.php?page=branchTransferConfirm">
                        	<i class="fa fa-cogs"></i>
                        	<span>Branch Transfer Confirm</span>
                        	<span class="pull-right-container">
                    		</span>
                      	</a>
                     </li>
                   ...
                   <!-- <li class="treeview">
                  		<a href="">
                    		<i class="fa fa-cart-plus"></i> <span>Branch Transfer</span>
                            <span class="pull-right-container">
                              	<i class="fa fa-angle-left pull-right"></i>
                            </span>
                  		</a>
                  		<ul class="treeview-menu">
                            <li>
                            	<a href="welcome.php?page=branchTransfer">
                                	<i class="fa fa-circle-o"></i> Branch Transfer
                                </a>
                            </li>
                        </ul>
                	 </li>
